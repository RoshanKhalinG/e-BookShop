import karnali from "../assets/books-images/karnali.jpg";
import maha from "../assets/books-images/mahakoma.jpg";
import palpasa from "../assets/books-images/palpasa.jpg";
import phool from "../assets/books-images/phool.jpg";
import smrlove from "../assets/books-images/smerlove.jpg";
import setod from "../assets/books-images/setodharti.jpg";
import swapna from "../assets/books-images/swapnabhumi.jpg";
import khusi from "../assets/books-images/khusi.jpg";
export const BookData = [
  ...
  {
    id: 17,
    book_name: "Summer Love",
    book_description:
      "समर लभ एक लोकप्रिय नेपाली उपन्यास हो, जसले सुबिन भट्टराईले लेखेका छन्। यो एक प्रेमकथा हो जसले काठमाण्डौ, नेपालको गर्मीमा भएको वातावरणमा स्थायी गरेको छ। पुस्तकमा युवाहरूको प्रेम, सम्बन्धहरू, र व्यक्तिगत विकासलाई चित्रण गरिएको छ। उत्साही कलाकार आतित र तलेन्टेड चिकित्सा विद्यार्थिनी सायाको प्रेमको परिप्रेक्ष्यमा पुस्तकले नेपालको संस्कृति, समाज, र आधुनिक युवाहरूले आफ्ना सपनाहरूमा नजिक हुनुपर्ने चुनौतीहरूलाई सुन्दर ढंगले प्रतिबिम्बित गरेको छ। समर लभ लागूत्तम नेपाली साहित्यिक कृतिहरूमा गरेको छ र नेपालमा यसको उत्कृष्ट प्राणी भएको छ।",
    book_url: smrlove,
  ...
  },
  {
    ...
    book_name: "MahaKo Ma",
    book_description:
      "मदन कृष्णको महको म नामको पुस्तक नेपाली भाषामा लेखित गरिएको छ। यो पुस्तकले नेपालको एक प्रसिद्ध कलाकार एक अद्भुत गर्दा, रोमान्चको तथा उसको महत्वका दृश्यहरूको बारेमा भनेर एक कथा बर्णना गरेको छ। यस पुस्तकले व्यंग्य, हास्य, र गरिबीको किस्साहरूले यात्रा गर्दा पारिवारिक बन्धन, साहसिक क्षणहरू, र विश्वासको बारेमा पनि बोलाउँछ।",
    book_url: maha,
    print_length: "500 pages",
    language: "Nepali",
    author_name: "Madan Krishna Shrestha",
    price: "600",
  },
  {
    id: 19,
    book_name: "Seto Dharti",
    book_description:
      "सेतो धरती नेपाली चलचित्रको विशेषता भनेको यसको अलौकिक कथा, शैली, रचना, तकनीक र परिचय हो। यो चलचित्रले नेपालको चलचित्र उद्योगले विश्वसनीयता, विस्तार, र सामर्थ्यको प्रतिकटान गरेको छ। सेतो धरती चलचित्रमा परेखिएको कथा नेपालका विविध संस्कृति, परम्परा, र रूपहरूलाई समर्थन गर्दैछ। यसले नेपाली समाजमा अस्पृश्यता, सामाजिक विभेद, राजनीतिक समस्या, औद्योगिकीकरणका असरहरू, र विकासका समस्याहरूलाई प्रतिबिम्बित गरेको छ। चलचित्रमा प्रदर्शित गरिएको एक पूर्वपरम्परागत किस्सा हो, जसमा मुख्य पात्रको भूमिका अत्यन्त माहत्त्वपूर्ण छ। यो किस्सा द्वारा नेपालका ऐतिहासिक घटना, राजकीय परिस्थिति, राजा-मन्त्रीको सम्बन्ध, र राजनीतिक नगरिकको महत्वपूर्ण क्षणहरू प्रतिबिम्बित गरिएको छ।",
    book_url: setod,
    print_length: "425 pages",
    language: "Nepali",
    author_name: "Amar Neupane",
    price: "400",
  },
  {
    id: 20,
    book_name: "Karnali Blues",
    book_description:
      "कर्णाली ब्लुज़ नेपाली उपन्यासहरूबीचको एक चित्रण हो, जुन रोमान्टिक, सांस्कृतिक, र राजनीतिक विविधताहरू सहितको एक यात्रा हो। उपन्यास लेखक बुद्धिप्रसाद गुप्ताले नेपाली जीवनका पहाडी एवं तराइका भूभागहरू, समाज, परिवार, और संघर्षलाई विवेचना गर्दछन्। यस उपन्यासमा भावनात्मक विश्लेषण, समाजिक मुद्दा, र व्यक्तिगत समस्याहरूको वर्णन भएको छ।",
    book_url: karnali,
    print_length: "350 pages",
    language: "Nepali",
    author_name: "Buddhi Sagar",
    price: "200",
  },
  {
    id: 21,
    book_name: "Swapna Bhumi",
    book_description:
      "स्वप्नभूमि एक नेपाली पुस्तक हो जुनले प्रेम, साहित्य, र स्वप्नहरूको अद्भुत गठन गर्दछ। यस पुस्तकमा सार्वजनिक जीवनको सङ्क्षेपणहरू, स्वप्नहरूको उधारणीय वर्णन, र एक संसारको पूर्णता र नाम्रताको अनुभव गर्दा, पाठकलाई मोह लग्दछ। लेखकले उत्कृष्ट भाषा र चित्रणको माध्यमबाट पाठकलाई मनमुटाउँछन् र साथै नेपालका सांस्कृतिक सृष्टिहरूसम्म पनि भ्रमण गराउँछ। पुस्तकले पाठकलाई जीवनका महत्वपूर्ण मुद्दाहरूको सामाजिक चिन्हहरूसँग परिचित गराउँछ र उनीहरूलाई नयाँ दृष्टिकोण प्रदान गर्दछ।",
    book_url: swapna,
    print_length: "500 pages",
    language: "Nepali",
    author_name: "Tulasi Acharya",
    price: "360",
  },
  {
    id: 22,
    ...
    book_description:
      "पल्पसा क्याफे एक नेपाली उपन्यास हो, जुन नेपालको अद्भुत तथा भयानक युद्धको दशक अनुभव गरेको एक युवा कलाकार पल्पसा र तिनको प्रेमकथा संबन्धी छ। विदेश बसेका रहेका पल्पसाको मुलुक पर्यटनको संकटमा छ र यसले उनको प्रेमी संघर्षको चर्चामा लगाउँछ। यो उपन्यास राजनीतिक र साहित्यिक मुद्दाहरूमा समृद्ध छ र व्यक्तिगत स्तरमा प्रेम र मानवताको बारेमा भी सोचने मनाउँछ।",
    book_url: palpasa,
    print_length: "500 pages",
    language: "Nepali",
    author_name: "Narayan Wagle",
    price: "400",
  },
];
